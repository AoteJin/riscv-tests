...
class spike32_sdsec_mmode_hart(targets.Hart):
    xlen = 32
    ram = 0x10100000
    ram_size = 0x10000000
    bad_address = ram - 8
...
class spike32_sdsec_mmode(targets.Target):
    harts = [spike32_sdsec_mmode_hart(misa=0x4034112d)]
    openocd_config_path = "spike-sdsec.cfg"
    timeout_sec = 180
