...
class spike32_sdsec_smode_hart(targets.Hart):
    xlen = 32
    ram = 0x10100000
    ram_size = 0x10000000
    bad_address = ram - 8
...
class spike32_sdsec_smode(targets.Target):
    harts = [spike32_sdsec_smode_hart(misa=0x4034112d)]
